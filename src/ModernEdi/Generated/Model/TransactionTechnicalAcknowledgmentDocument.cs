...
/// <summary>Stored X12 technical acknowledgment.</summary>

public sealed class TransactionTechnicalAcknowledgmentDocument
{
    /// <summary>Stable id of the stored X12 technical-acknowledgment artifact.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects the X12 technical-acknowledgment renderer and transport metadata shape.</summary>
