...
/// <summary>Complete response-only replay output, including the regenerated body.</summary>

public sealed class TransactionMappedOutput
{
    ...
    /// <summary>Mapped output body. Parse according to &#x60;contentType&#x60;.</summary>
