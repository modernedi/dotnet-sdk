...
/// <summary>Raw inbound or outbound X12 transaction document.</summary>

public sealed class TransactionX12Document
{
    /// <summary>Stable id of the retained raw X12 artifact.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects the raw-X12 document renderer and empty metadata shape.</summary>
    ...
    /// <summary>Raw X12 has no additional document metadata; transaction identity is available on the enclosing detail.</summary>
