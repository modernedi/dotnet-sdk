...
public sealed class TransactionPrimaryMdnDocument
{
    /// <summary>Stable id of the original transaction&#39;s full MDN report.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects an AS2 MDN report renderer; this id selects full receipt-assurance metadata.</summary>
    ...
    [JsonRequired]
    public TransactionMdnDocumentMetadata Metadata { get; set; } = default!;
