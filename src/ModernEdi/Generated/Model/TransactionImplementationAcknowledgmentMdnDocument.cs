...
public sealed class TransactionImplementationAcknowledgmentMdnDocument
{
    /// <summary>Stable id of the MDN report attached to the X12 999.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects an AS2 MDN report renderer; this id selects compact 999-MDN metadata.</summary>
    ...
    [JsonRequired]
    public TransactionImplementationAcknowledgmentMdnMetadata Metadata { get; set; } = default!;
