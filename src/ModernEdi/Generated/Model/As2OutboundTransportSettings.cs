...
/// <summary>Optional outbound AS2 algorithms and MIME-compatibility controls. Each omitted field receives its documented default.</summary>

public sealed class As2OutboundTransportSettings
{
    ...
    public Optional<string> SigningAlgorithm { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public Optional<string> EncryptionAlgorithm { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public Optional<string> CompressionAlgorithm { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public Optional<string> MicAlgorithm { get; set; }
    ...
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
    public Optional<string> MicAlgorithmFormat { get; set; }
