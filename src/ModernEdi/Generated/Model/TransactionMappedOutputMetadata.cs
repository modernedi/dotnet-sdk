...
/// <summary>Metadata and map provenance for an application-facing document produced by an incoming map.</summary>

public sealed class TransactionMappedOutputMetadata
{
