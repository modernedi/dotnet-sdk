...
/// <summary>Raw HTTP response retained with a technical acknowledgment.</summary>

public sealed class TransactionHttpResponseDocument
{
    /// <summary>Stable id of the raw HTTP response retained with a technical acknowledgment.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects the plain-text HTTP-response renderer and transport metadata shape.</summary>
    ...
    [JsonRequired]
    public TransactionTechnicalAcknowledgmentDocumentMetadata Metadata { get; set; } = default!;
