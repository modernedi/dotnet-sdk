...
/// <summary>Stored X12 999 and its normalized acknowledgment, group, and transaction-set evaluation.</summary>

public sealed class TransactionImplementationAcknowledgmentDocument
{
    /// <summary>Stable id of the stored X12 999 artifact.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects the X12 999 renderer and normalized acknowledgment metadata shape.</summary>
    ...
    [JsonRequired]
    public TransactionImplementationAcknowledgmentDocumentMetadata Metadata { get; set; } = default!;
