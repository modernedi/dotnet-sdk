...
/// <summary>Complete immutable mapping configuration, including the exact advanced runtime values that participate in its configuration hash.</summary>

public sealed class MappingConfigurationSnapshot
{
