...
public sealed class TransactionDocumentBase
{
    /// <summary>Stable artifact identifier within this transaction response, not a queue acknowledgment id.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Machine-readable artifact category used to choose rendering and operator controls.</summary>
    ...
    /// <summary>Structured metadata whose concrete schema is selected by &#x60;type&#x60; and, for MDNs, &#x60;id&#x60;.</summary>
