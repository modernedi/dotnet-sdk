...
public sealed class TransactionFunctionalAcknowledgmentMdnDocument
{
    /// <summary>Stable id of the MDN report attached to the X12 997.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects an AS2 MDN report renderer; this id selects compact 997-MDN metadata.</summary>
    ...
    [JsonRequired]
    public TransactionFunctionalAcknowledgmentMdnMetadata Metadata { get; set; } = default!;
