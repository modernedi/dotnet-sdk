...
/// <summary>Normalized X12 999 outcome and the evaluation selected for the enclosing transaction.</summary>

public sealed class TransactionImplementationAcknowledgmentDocumentMetadata
{
    /// <summary></summary>
