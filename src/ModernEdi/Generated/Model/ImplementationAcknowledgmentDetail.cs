...
/// <summary>Metadata and normalized outcome for a stored X12 999. Fetch the indexed implementation-acknowledgment document for the X12 body.</summary>

public sealed class ImplementationAcknowledgmentDetail
{
    /// <summary></summary>
    ...
    /// <summary>AS2 Message-Id of the stored 999, or &#x60;null&#x60; when only partial acknowledgment data was retained.</summary>
    [JsonPropertyName("messageId")]
    [JsonRequired]
    public string? MessageId { get; set; } = default!;

    /// <summary>Delivery/persistence completion flag from the retained 999 record. True means its acknowledgment lifecycle completed, false means it did not, and &#x60;null&#x60; means the state is unavailable. This is not sender direction; use the transaction direction and timeline event type to determine whether ModernEDI sent or received the 999.</summary>
    ...
    /// <summary>AS2 receipt assurance state for the 999, or &#x60;null&#x60; when no MDN applies or was recorded.</summary>
    [JsonPropertyName("mdn")]
    [JsonRequired]
    public TransactionMdn? Mdn { get; set; } = default!;

    /// <summary>Whether this transaction was evaluated against its exact AK2/IK5 result, a unique AK1/AK9 group, or the conservative whole-999 aggregate.</summary>
    [JsonPropertyName("evaluationScope")]
    [JsonRequired]
    public string? EvaluationScope { get; set; } = default!;

    /// <summary>Exact AK2/IK5 outcome attributable to this transaction, or &#x60;null&#x60;.</summary>
