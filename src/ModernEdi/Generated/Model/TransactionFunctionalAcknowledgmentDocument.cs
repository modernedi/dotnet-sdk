...
/// <summary>Stored X12 997 and its normalized group and transaction-set evaluation.</summary>

public sealed class TransactionFunctionalAcknowledgmentDocument
{
    /// <summary>Stable id of the stored X12 997 artifact.</summary>
    [JsonPropertyName("id")]
    [JsonRequired]
    public string Id { get; set; } = default!;

    /// <summary>Selects the X12 997 renderer and normalized acknowledgment metadata shape.</summary>
    ...
    [JsonRequired]
    public TransactionFunctionalAcknowledgmentDocumentMetadata Metadata { get; set; } = default!;
