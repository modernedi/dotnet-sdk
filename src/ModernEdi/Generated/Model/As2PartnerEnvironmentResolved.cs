...
/// <summary>Persisted AS2 partner environment with all secure inbound-protection defaults resolved.</summary>

public sealed class As2PartnerEnvironmentResolved
{
